...
- [x] P4-8：Terminal command approval，审批 modal 展示命令、cwd、风险等级、风险原因、上一条 shell 输出摘要和持久化选项。
